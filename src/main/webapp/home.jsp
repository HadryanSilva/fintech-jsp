...
<nav
		...
		id="mainNav">
	<div class="container">
		<a class="navbar-brand" href="#page-top">Fintech</a>
		<button
...
<header class="masthead bg-primary text-white text-center">
	<div class="container d-flex align-items-center flex-column">
		...
		<p class="masthead-subheading font-weight-light mb-0">Descomplicando Sua Vida</p>
	</div>
</header>
...
<section class="page-section" id="contact">
	<div class="container">
		<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0">Fale Conosco</h2>
		<div class="divider-custom">
			<div class="divider-custom-line"></div>
			<div class="divider-custom-icon">
				<i class="fas fa-star"></i>
			...
			<div class="modal-body text-center pb-5">
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-lg-8">
							<h2
									class="portfolio-modal-title text-secondary text-uppercase mb-0">Salvar Despesa</h2>
							<div class="divider-custom">
								<div class="divider-custom-line"></div>
								<div class="divider-custom-icon">
									<i class="fas fa-star"></i>
															...
															<div class="row">
																...
																<div class="col-md-12">
																	<div class="form-group">
																		...
																		<input id="montante" type="number"  step="0.01" name="montante" min="0.01" class="form-control"
																			   placeholder="Informe o valor *" required="required"
																			   data-error="Informe o valor.">
																	</div>
																</div>
																<div class="col-md-12">
																	<div class="form-group">
																		...
																		<input id="data" type="datetime-local"  name="data" placeholder="MM/DD/YYY"  class="form-control"
																			   required="required"
																			   data-error="Informe a data.">
																	</div>
																</div>
